...
urlpatterns = [
    ...
    path('get_info_professors_api/', views.ProfessorAPIView.as_view(), name='get-info-professors-api'),
    path('get_professors_api/<int:pk>/', views.ProfessorPKApiView.as_view(), name='get-professors-api')
]
