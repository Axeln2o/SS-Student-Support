...
class StudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = (
            'first_name', 'last_name', 'age', 'is_olympic', 'email_field', 'description', 'start_date', 'end_date',
        ...
        widgets = {
            ...
            'email_field': EmailInput(attrs={'placeholder': 'Enter your email', 'class': 'form-control'}),
